...
座標は、左上から始まり、反時計回りに指定しなければならない。 +
https://bigladdersoftware.com/epx/docs/9-4/input-output-reference/group-thermal-zone-description-geometry.html#buildingsurfacedetailed[<bigladder>, role="external", window="_blank"]
