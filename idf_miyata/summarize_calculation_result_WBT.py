...
for room_name in roomlist:
    ...
    if "事務室" in room_name and "2-6F" in room_name:
        ...
        output_sensible_data = output_sensible_data.append(data[ roomlist[room_name]["ID"] + " sensible_heat_load" ]["2021-11-1 0:00:00":"2021-11-2 1:00:00"] )
        ...
        output_latent_data = output_latent_data.append(data[ roomlist[room_name]["ID"] + " latent_heat_load" ]["2021-11-1 0:00:00":"2021-11-2 1:00:00"] )
        ...
        output_temperature_data = output_temperature_data.append(data[ roomlist[room_name]["ID"] + temperature ]["2021-11-1 0:00:00":"2021-11-2 1:00:00"] )
        ...
        output_humidity_data = output_humidity_data.append(data[ roomlist[room_name]["ID"] + humidity ]["2021-11-1 0:00:00":"2021-11-2 1:00:00"] )
...
for room_name in roomlist:
    ...
    if "事務室" in room_name and "2-6F" in room_name:
        ...
        plt.subplots_adjust(left=0.09, bottom=0.05, right=0.97, top=0.95, wspace=0.15, hspace=0.40)
        plt.subplot(411)
        plt.plot(data[roomlist[room_name]["ID"] + ":Zone Mean Air Temperature [C](Hourly)"]["2021-01-04 0:00:00":"2021-01-07 1:00:00"]) 
        plt.title("室温の変動: " +room_name)
        plt.ylabel("室温 [℃]")
        plt.ylim([5,35])
        plt.grid()
        ...
        plt.subplot(412)
        plt.plot(data[roomlist[room_name]["ID"] + ":Zone Mean Air Humidity Ratio [kgWater/kgDryAir](Hourly)"]["2021-01-04 0:00:00":"2021-01-07 1:00:00"]*1000) 
        plt.title("絶対湿度の変動: " +room_name)
        plt.ylabel("絶対湿度 [g/kgDA]")
        plt.ylim([0,20])
        plt.grid()
        ...
        plt.subplot(413)
        plt.plot(data[roomlist[room_name]["ID"]  + sensible_cooling_rate_W]["2021-01-04 0:00:00":"2021-01-07 1:00:00"]/roomlist[room_name]["面積"], 'b')
        plt.plot(data[roomlist[room_name]["ID"]  + sensible_heating_rate_W]["2021-01-04 0:00:00":"2021-01-07 1:00:00"]*(-1)/roomlist[room_name]["面積"], 'r')
        plt.title("顕熱負荷の変動: " +room_name)
        plt.ylabel("顕熱負荷 [W/㎡]")
        plt.grid()

        plt.subplot(414)
        plt.plot(data[roomlist[room_name]["ID"]  + latent_cooling_rate_W]["2021-01-04 0:00:00":"2021-01-07 1:00:00"]/roomlist[room_name]["面積"], 'b')
        plt.plot(data[roomlist[room_name]["ID"]  + latent_heating_rate_W]["2021-01-04 0:00:00":"2021-01-07 1:00:00"]*(-1)/roomlist[room_name]["面積"], 'r')
        ...
        plt.subplots_adjust(left=0.09, bottom=0.05, right=0.97, top=0.95, wspace=0.15, hspace=0.40)
        plt.subplot(411)
        plt.plot(data[roomlist[room_name]["ID"] + ":Zone Mean Air Temperature [C](Hourly)"]["2021-04-05 0:00:00":"2021-04-08 1:00:00"]) 
        plt.title("室温の変動: " +room_name)
        plt.ylabel("室温 [℃]")
        plt.ylim([5,35])
        plt.grid()
        ...
        plt.subplot(412)
        plt.plot(data[roomlist[room_name]["ID"] + ":Zone Mean Air Humidity Ratio [kgWater/kgDryAir](Hourly)"]["2021-04-05 0:00:00":"2021-04-08 1:00:00"]*1000) 
        plt.title("絶対湿度の変動: " +room_name)
        plt.ylabel("絶対湿度 [g/kgDA]")
        plt.ylim([0,20])
        plt.grid()
        ...
        plt.subplot(413)
        plt.plot(data[roomlist[room_name]["ID"]  + sensible_cooling_rate_W]["2021-04-05 0:00:00":"2021-04-08 1:00:00"]/roomlist[room_name]["面積"], 'b')
        plt.plot(data[roomlist[room_name]["ID"]  + sensible_heating_rate_W]["2021-04-05 0:00:00":"2021-04-08 1:00:00"]*(-1)/roomlist[room_name]["面積"], 'r')
        plt.title("顕熱負荷の変動: " +room_name)
        plt.ylabel("顕熱負荷 [W/㎡]")
        plt.grid()

        plt.subplot(414)
        plt.plot(data[roomlist[room_name]["ID"]  + latent_cooling_rate_W]["2021-04-05 0:00:00":"2021-04-08 1:00:00"]/roomlist[room_name]["面積"], 'b')
        plt.plot(data[roomlist[room_name]["ID"]  + latent_heating_rate_W]["2021-04-05 0:00:00":"2021-04-08 1:00:00"]*(-1)/roomlist[room_name]["面積"], 'r')
        plt.title("潜熱負荷の変動: " +room_name)
        plt.ylabel("潜熱負荷 [W/㎡]")
        plt.grid()
        ...
        plt.subplots_adjust(left=0.09, bottom=0.05, right=0.97, top=0.95, wspace=0.15, hspace=0.40)
        plt.subplot(411)
        plt.plot(data[roomlist[room_name]["ID"] + ":Zone Mean Air Temperature [C](Hourly)"]["2021-07-18 0:00:00":"2021-07-21 1:00:00"]) 
        plt.title("室温の変動: " +room_name)
        plt.ylabel("室温 [℃]")
        plt.ylim([5,35])
        plt.grid()
        ...
        plt.subplot(412)
        plt.plot(data[roomlist[room_name]["ID"] + ":Zone Mean Air Humidity Ratio [kgWater/kgDryAir](Hourly)"]["2021-07-21 0:00:00":"2021-07-19 1:00:00"]*1000) 
        plt.title("絶対湿度の変動: " +room_name)
        plt.ylabel("絶対湿度 [g/kgDA]")
        plt.ylim([0,20])
        plt.grid()
        ...
        plt.subplot(413)
        plt.plot(data[roomlist[room_name]["ID"]  + sensible_cooling_rate_W]["2021-07-18 0:00:00":"2021-07-21 1:00:00"]/roomlist[room_name]["面積"], 'b')
        plt.plot(data[roomlist[room_name]["ID"]  + sensible_heating_rate_W]["2021-07-18 0:00:00":"2021-07-21 1:00:00"]*(-1)/roomlist[room_name]["面積"], 'r')
        plt.title("顕熱負荷の変動: " +room_name)
        plt.ylabel("顕熱負荷 [W/㎡]")
        plt.grid()

        plt.subplot(414)
        plt.plot(data[roomlist[room_name]["ID"]  + latent_cooling_rate_W]["2021-07-18 0:00:00":"2021-07-21 1:00:00"]/roomlist[room_name]["面積"], 'b')
        plt.plot(data[roomlist[room_name]["ID"]  + latent_heating_rate_W]["2021-07-18 0:00:00":"2021-07-21 1:00:00"]*(-1)/roomlist[room_name]["面積"], 'r')
        plt.title("潜熱負荷の変動: " +room_name)
        plt.ylabel("潜熱負荷 [W/㎡]")
        plt.grid()
        ...
        plt.subplots_adjust(left=0.09, bottom=0.05, right=0.97, top=0.95, wspace=0.15, hspace=0.40)
        plt.subplot(411)
        plt.plot(data[roomlist[room_name]["ID"] + ":Zone Mean Air Temperature [C](Hourly)"]["2021-11-1 0:00:00":"2021-11-4 1:00:00"]) 
        plt.title("室温の変動: " +room_name)
        plt.ylabel("室温 [℃]")
        plt.ylim([5,35])
        plt.grid()
        ...
        plt.subplot(412)
        plt.plot(data[roomlist[room_name]["ID"] + ":Zone Mean Air Humidity Ratio [kgWater/kgDryAir](Hourly)"]["2021-11-1 0:00:00":"2021-11-4 1:00:00"]*1000) 
        plt.title("絶対湿度の変動: " +room_name)
        plt.ylabel("絶対湿度 [g/kgDA]")
        plt.ylim([0,20])
        plt.grid()
        ...
        plt.subplot(413)
        plt.plot(data[roomlist[room_name]["ID"]  + sensible_cooling_rate_W]["2021-11-1 0:00:00":"2021-11-4 1:00:00"]/roomlist[room_name]["面積"], 'b')
        plt.plot(data[roomlist[room_name]["ID"]  + sensible_heating_rate_W]["2021-11-1 0:00:00":"2021-11-4 1:00:00"]*(-1)/roomlist[room_name]["面積"], 'r')
        plt.title("顕熱負荷の変動: " +room_name)
        plt.ylabel("顕熱負荷 [W/㎡]")
        plt.grid()

        plt.subplot(414)
        plt.plot(data[roomlist[room_name]["ID"]  + latent_cooling_rate_W]["2021-11-1 0:00:00":"2021-11-4 1:00:00"]/roomlist[room_name]["面積"], 'b')
        plt.plot(data[roomlist[room_name]["ID"]  + latent_heating_rate_W]["2021-11-1 0:00:00":"2021-11-4 1:00:00"]*(-1)/roomlist[room_name]["面積"], 'r')
        plt.title("潜熱負荷の変動: " +room_name)
        plt.ylabel("潜熱負荷 [W/㎡]")
        plt.grid()
